        ...
        <ul class="layui-nav layui-nav-tree" lay-filter="leftNav">
            				  <li class="layui-nav-item layui-nav-itemed">
            				    ...
            				    <dl class="layui-nav-child">
            				      <dd><a href="javascript:;"  data-id='1' data-text="用户"><span class="l-line"></span>用户</a></dd>
            				      <dd><a href="javascript:;" data-id='2' data-text="车辆"><span class="l-line"></span>车辆</a></dd>
            				      <dd><a href="javascript:;"  data-id='3' data-text="传感器"><span class="l-line"></span>传感器</a></dd>
            				    </dl>
            				  </li>
...
<%--            </li>--%>
            <li class="layui-nav-item">
                <a href="javascript:;" data-id='5' data-text="个人信息"><i
...
<%--                </li>--%>
                <li class="layui-nav-item">
                    <a href="javascript:;" data-id='5' data-text="个人信息">管理员</a>
                </li>
                <li class="layui-nav-item">
            ...
            <div class="layui-tab layui-tab-brief main-layout-tab" lay-filter="tab" lay-allowClose="true">
                ...
                <div class="layui-tab-content">
                    <div class="layui-tab-item layui-show" style="background: #f5f5f5;">
                        <!--1-->
                        <iframe src="<%=basePath%>/jsp/admin/index/welcome.jsp" width="100%" height="100%" name="iframe"
